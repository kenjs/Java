...
public class DctmsLogThreadInit implements ServletContextListener {

    private static Logger log = LoggerFactory.getLogger(DctmsLogThreadInit.class);
    ...
    public void contextInitialized(ServletContextEvent servletContextEvent) {
        ...
        Object obj = applicationContext.getBean("logRecorder");

        //记录用户操作日志线程
        threadProvider = (LogRecorderImpl) obj;
