 ...
 */
@Scope("prototype")
@Controller("selectNearByCargoListAction")
public class SelectNearByCargoListAction extends AuthenticationAction{
	...
	@RequestMapping(value = "/selectNearByCargoListAction")
    @ResponseBody
    @Log(type = 14)
...
//			String listSize = request.getParameter("listSize");
            ...
            log.error("SelectNearByCargoListAction.class - " + e.getMessage());
