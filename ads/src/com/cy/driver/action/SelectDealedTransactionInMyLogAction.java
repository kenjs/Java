 ...
 */
@Scope("prototype")
@Controller("selectDealedTransactionInMyLogAction")
public class SelectDealedTransactionInMyLogAction extends AuthenticationAction{
    ...
    @RequestMapping(value = "/selectDealedTransactionInMyLog")
    @ResponseBody
    @Log(type = 51)
	public JSonResponse execute(String driverId, String fromSize, String listSize) throws Exception{
		try {
            ...
            log.error("SelectDealedTransactionInMyLogAction.class - " + e.getMessage());
