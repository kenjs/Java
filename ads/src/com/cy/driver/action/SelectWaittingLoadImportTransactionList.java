 ...
 */
@Scope("prototype")
@Controller("selectWaittingLoadImportTransactionList")
public class SelectWaittingLoadImportTransactionList extends AuthenticationAction{
	...
	@RequestMapping(value = "/selectWaittingLoadImportTransactionList")
    @ResponseBody
    @Log(type = 73)
	public JSonResponse execute(String driverId, String fromSize, String listSize) throws Exception {
		try {
            ...
            log.error("SelectWaittingLoadImportTransactionList.class - " + e.getMessage());
