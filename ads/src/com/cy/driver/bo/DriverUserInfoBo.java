...
public class DriverUserInfoBo implements Serializable{
	...
	private String submitTime;//认证提交时间
    ...
    private String driverLineJSON;

	private String registrationId;

    public String getDriverLineJSON() {
        return driverLineJSON;
    }

    public void setDriverLineJSON(String driverLineJSON) {
        this.driverLineJSON = driverLineJSON;
    }
