 ...
 *
 */
public class MarketingDriverBusinessLine implements Serializable{
	private static final long serialVersionUID = -2973887619463558640L;

	private int id;//主键（自增、初始值1）
	private int customerDriverId;//车源ID
	...
	private String deleteFlag;//状态
	private Date createTime;//创建时间
	private Date modifyTime;//修改时间

	public MarketingDriverBusinessLine() {
		super();
	}
	...
	public int getCustomerDriverId() {
		return customerDriverId;
	}

	public void setCustomerDriverId(int customerDriverId) {
