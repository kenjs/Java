...
public class DriverUserInfoDomain {
    ...
    private String mobileChanged = "n";//用户换手机登陆

	private String appVersion;

	private List<DriverImgDomain> driverImgs;
	private DriverTelephoneInfoDomain driverTelephoneInfoDomain;
	...
	public String getNoIimei() {
        if (StringUtils.isBlank(noIimei)) {
            return "";
        }
		return noIimei;
	}
    ...
    public String getMobileChanged() {
        return mobileChanged;
    }

    public void setMobileChanged(String mobileChanged) {
        this.mobileChanged = mobileChanged;
    }

	public List<DriverImgDomain> getDriverImgs() {
		if (driverImgs == null)
			driverImgs = new ArrayList<DriverImgDomain>();
		return driverImgs;
	}

	public void setDriverImgs(List<DriverImgDomain> driverImgs) {
		this.driverImgs = driverImgs;
	}
	...
	public DriverTelephoneInfoDomain getDriverTelephoneInfoDomain() {
		return driverTelephoneInfoDomain;
	}

	public void setDriverTelephoneInfoDomain(DriverTelephoneInfoDomain driverTelephoneInfoDomain) {
		this.driverTelephoneInfoDomain = driverTelephoneInfoDomain;
	}
}
