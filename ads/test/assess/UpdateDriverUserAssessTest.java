...
public class UpdateDriverUserAssessTest {

	private static Logger log = LoggerFactory.getLogger(UpdateDriverUserAssessTest.class);
	...
	public static String getHttp() throws Exception {
		...
		String id = "2";
		String assess = "很好啊！";
		String assessEvaluateScore = "5";
		
		String url = "http://localhost:8080/DriverService/updateDriverUserAssessAction";
