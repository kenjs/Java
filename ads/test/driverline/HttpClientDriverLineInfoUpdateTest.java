...
public class HttpClientDriverLineInfoUpdateTest {
	private static Logger log = LoggerFactory.getLogger(HttpClientDriverLineInfoUpdateTest.class);
	...
	public static String getHttp() throws Exception {
		...
		String url = "http://localhost:8080/DriverService/driverLineInfoUpdate";
