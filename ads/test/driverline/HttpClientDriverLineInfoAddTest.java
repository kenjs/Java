...
public class HttpClientDriverLineInfoAddTest {
	private static Logger log = LoggerFactory.getLogger(HttpClientDriverLineInfoAddTest.class);
	...
	public static String getHttp() throws Exception {
		...
		String endProvince = "江苏省";
		String endCity = "南京市";
		String start = "1";
		String lineType = "2";
		
		String url = "http://localhost:8080/DriverService/driverLineInfoAdd";
		...
		postMethod.addParameter("lineType", lineType);
		try {
