...
public class SysToolsUtil {
    ...
    private static final Logger log = LoggerFactory.getLogger(SysToolsUtil.class);
     ...
     *
     * @param list      需合并的字符串数组
     * @param separator 用于合并的分隔符
     * @return
     */
     ...
     * <p/>
     *
     * @param objects1 对象数组1。
     * @param objects2 对象数组2。
     * @return 两个数组的交集。
     * @author hst
