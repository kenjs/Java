...
public class MD5Util {
    ...
    *�?��的位运算，可能出于效率的考虑把它们实现成了宏，在java中，我们把它�?
 �?*实现成了private方法，名字保持了原来C中的�?
    ...
    */
    ...
    /*Encode把long数组按顺序拆成byte数组，因为java的long类型�?4bit的，
    * 只拆�?2bit，以适应原始C实现的用�?
    */
    ...
    */
    ...
    public static void main(String args[]) {
        ...
        if (Array.getLength(args) == 0) {
            log.debug("MD5加密[" + source + "]结果:" + m.getMD5ofStr(source));
        } else {
            log.debug("MD5(" + args[0] + ")=" + m.getMD5ofStr(args[0]));
        }
