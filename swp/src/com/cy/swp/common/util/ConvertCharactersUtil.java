...
public class ConvertCharactersUtil {
	...
	/**
	 * ISO-8859-1编码转换为utf-8
	 * 
	 * @param baseObjects
	 */
	// @SuppressWarnings("rawtypes")
	public static String convertISO2Utf(String va) throws Exception {
		String newVal="";
		newVal=new String(va.getBytes("ISO_8859_1"),"utf-8");
		return newVal;
	}
	 ...
	 * @param baseEntity
	 */
	public static void convertISO2UTF(Object baseEntity) throws Exception {
		if (baseEntity == null) {
			return;
		}
		convertEncode(ISO_8859_1, UTF8, baseEntity);
	}
