...
public class WebUserInfo extends BaseBo {
    ...
    /**权限***/
	private String pactCarDriverFlag;//VIP会员功能权限标识（0无权限1有权限）
	private String pactCardFlag;//身份证查询功能权限标识（0无权限1有权限）
	private String pactCargoFlag;//货主版功能权限标识（0无权限1有权限）
	...
	public String getPactCardFlag() {
		return pactCardFlag;
	}

	public void setPactCardFlag(String pactCardFlag) {
		this.pactCardFlag = pactCardFlag;
	}

	public String getPactCargoFlag() {
		return pactCargoFlag;
	}

	public void setPactCargoFlag(String pactCargoFlag) {
