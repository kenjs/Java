...
public class DriverUserInfo extends BaseBo {
    ...
    private String driverPactStart;// 司机VIP会员对外是否展示（0展示1不展示）
	...
	public String getDriverPactStart() {
		return driverPactStart;
	}

	public void setDriverPactStart(String driverPactStart) {
		this.driverPactStart = driverPactStart;
	}
