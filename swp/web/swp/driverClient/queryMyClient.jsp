...
<head>
  ...
  <script type="text/javascript" src="<sys:context/>/resource/artDialog4.1.6/jquery.artDialog.js"></script>

  <script type="text/javascript">
    $(function(){
      //获取司机信息
      getDriverInfo('<%=id %>');
      getActiveDriverInfo('<%=driverId %>');
      //获取运营线路
      getDriverLine('<%=driverId %>','Y');
      //获取预约线路
      getDriverBuLineList('<%=driverId %>','Y');
      //获取客户类别
      getCategoryHtml('<%=id %>');
      //获取客户维护记录
    ...
    <div class="tabfl" style="width:889px; float: right;">
      <table border="0" cellspacing="0" cellpadding="3" >
        <tr>
          ...
          <td id="customerTypeHtml" width="289">客户状态：</td>
          <td id="mobilePhoneHtml" width="392">联系方式：</td>
        </tr>
      </table>
      <table border="0" cellspacing="1" cellpadding="3" >
        <tr>
          ...
          <td width="300" id="identityLicenseNumHtml"></td>
        </tr>
        <tr>
          <td colspan="3" width="275"><a href="javascript:getDriverImg('1');">行驶证（查看）</a></td>
          <td colspan="3" width="560"><a href="javascript:getDriverImg('0');">驾驶证（查看）</a></td>
        </tr>
      </table>
      <table border="0" cellspacing="1" cellpadding="3" style="margin-top:-1px;" >
        <tr>
          ...
          <td width="90" id="reghtTimeHtml"></td>
          <td width="122">近15天使用次数</td>
          <td width="255" id="user15DayNumHtml"></td>
          <td width="105">交易笔数</td>
          <td width="155" id="transactionCountHtml"></td>
        </tr>
        <tr>
          <td>最近使用时间</td>
          <td id="lastUserTimeHtml"></td>
          <td>最近定位地点</td>
          <td id="lastLocationHtml"></td>
          <td>最近定位时间</td>
          <td id="lastLocationTimeHtml"></td>
        </tr>
      </table>
      <table border="0" cellspacing="1" cellpadding="3" style="margin-top:-1px;">
        <tr>
          ...
          <td width="83"><input name="" type="button" value="编辑" onclick="queryDriverInfo('Y');"/></td>
        </tr>
      </table>
      <table border="0" cellspacing="1" cellpadding="3" style="margin-top:-1px;">
        <tr>
          ...
          <td width="103">
            ...
            <input name="" type="button" value="编辑" onclick="queryDriverLineById('0','Y');"/>
          </td>
          <td width="126" id="oftenCity1Html"></td>
          <td width="126" id="oftenCity2Html"></td>
          <td width="127" id="oftenCity3Html"></td>
        </tr>
        <tr>
          <td id="driverLineHtml1"></td><!-- 运营线路1 -->
          <td>
            <input id="driverLineId1" name="driverLineId1" type="hidden" value="" />
            <input name="" type="button" value="编辑" onclick="queryDriverLineById('1','Y');"/>
          </td>
        ...
        <tr>
          ...
          <td>
            ...
            <input name="" type="button" value="编辑" onclick="queryDriverLineById('2','Y');"/>
          </td>
          <td colspan="3" width="382">线路不固定，常跑城市线路
            <input name="" type="button" value="编辑" onclick="queryDirverInfoSetOftenCity('Y');"/></td>
        </tr>
      </table>
            ...
            <div style="width:100%; height:100px;  overflow:auto;">
              <table border="0" cellspacing="1" cellpadding="3" style="margin:-1px;" id="cargoHtml">
                <tr style="font-weight:bold;">
                  ...
                  <td width="76">规则</td>
                  <td width="145"><a href="javascript:queryMarketingOrderCargoById('Y');">匹配货源>></a></td>
                </tr>
              </table>
            </div>
          </td>
      ...
      <table class="tabow" border="0" cellspacing="1" cellpadding="3" style="margin-top:-1px;">
        <tr>
          ...
          <td colspan="2" class="number" width="563">
            <dl>
              <dt>手机号码</dt>
              <dd><span id="mobilePhone1Html"></span><span><i>&nbsp;</i></span></dd>
          ...
          <td width="272"><input name="" type="button" value="无效号码" onclick="queryWuxiaohaoma();"/><span><input name="" type="button" value="发送短信" onclick="setNoteInfo('Y');"/></span></td>
        </tr>
        <tr>
