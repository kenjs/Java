...
function queryData() {
	...
	$.ajax({
		type: "post",
		url: "/user/queryPayOderTranOder.jspx",
		dataType: "json",
...
function sendCitiesAjax() {
	$.ajax({
		type: "get",
		url: jcontextPath+'/resource/threeLinkage/js/queryAllCities.js',
		async: false,
		dataType: "json",
...
function sendAllProvinceAjax() {
	$.ajax({
		type: "get",
		url: jcontextPath+'/resource/threeLinkage/js/queryAllProvinces.js',
		async: false,
		dataType: "json",
		success: function(data) {
...
function sendAllCitiesAjax() {
	$.ajax({
		type: "get",
		url: jcontextPath+'/resource/threeLinkage/js/queryCities.js',
		async: false,
		dataType: "json",
		success: function(data) {
...
function sendAllCountiesAjax()
 {
	$.ajax({
		type: "get",
		url: jcontextPath+"/resource/threeLinkage/js/queryAllAreas.js",
		async: false,
		dataType: "json",
		success: function(data) {
			allAreas = data.areas;
