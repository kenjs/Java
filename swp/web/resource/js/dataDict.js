...
function getCarPlateTypeDict(obj){
	$.ajax({
		type: "POST",
	   	async:false,
	   	url: jcontextPath + "/getCarPlateTypeDict.jspx",
	   	dataType:"json",	
	   	...
	   	success:function(data){
	   		...
	   		loadSelectOption(obj, data.content);
	   	},
	    error:function(data){
...
function getCarBarTypeDict(obj){
	$.ajax({
		type: "POST",
	   	async:false,
	   	url: jcontextPath + "/getCarBarTypeDict.jspx",
	   	dataType:"json",	
	   	contentType: "application/x-www-form-urlencoded; charset=GBK", 
	   	success:function(data){
	   		if(data == null){
...
function getCarStateTypeDict(obj){
	$.ajax({
		type: "POST",
	   	async:false,
	   	url: jcontextPath + "/getCarStateTypeDict.jspx",
	   	dataType:"json",	
	   	contentType: "application/x-www-form-urlencoded; charset=GBK", 
	   	success:function(data){
	   		if(data == null){
...
function getCarLengthDict(obj){
	$.ajax({
		type: "POST",
	   	async:false,
	   	url: jcontextPath + "/getCarLengthDict.jspx",
	   	dataType:"json",	
...
function getCarWeightDict(obj){
	$.ajax({
		type: "POST",
	   	async:false,
	   	url: jcontextPath + "/getCarWeightDict.jspx",
	   	dataType:"json",	
	   	contentType: "application/x-www-form-urlencoded; charset=GBK", 
	   	success:function(data){
	   		if(data == null){
...
function getCarCubageDict(obj){
	$.ajax({
		type: "POST",
	   	async:false,
	   	url: jcontextPath + "/getCarCubageDict.jspx",
	   	dataType:"json",	
	   	contentType: "application/x-www-form-urlencoded; charset=GBK", 
	   	success:function(data){
	   		if(data == null){
...
function getCargoTypeDict(obj){
	$.ajax({
		type: "POST",
	   	async:false,
	   	url: jcontextPath + "/getCargoTypeDict.jspx",
	   	dataType:"json",	
	   	contentType: "application/x-www-form-urlencoded; charset=GBK", 
	   	success:function(data){
	   		if(data == null){
