package com.cy.dcts.common.constants;
...
//----------------------------用户类型（物流企业0、发货方1、收货方2）------------------------
		/**用户类型-物流企业- 0*/
		public static final String 	USER_TYPE_ENTERPRISE_KEY = "0";
		/**用户类型-物流企业*/
		public static final String USER_TYPE_ENTERPRISE_VALUE= "承运商";
		/**用户类型-发货方- 1*/
		public static final String 	USER_TYPE_SHIPPER_KEY = "1";
		/**用户类型-发货方*/
		public static final String USER_TYPE_SHIPPER_VALUE= "发货方";
		/**用户类型-收货方- 2*/
		public static final String 	USER_TYPE_RECEIVE_KEY = "2";
		/**用户类型-收货方*/
		public static final String USER_TYPE_RECEIVE_VALUE= "收货方";
...
//------------------------货源装货时间是否过期（是否失效）----------------------------
 ...
 //----------------------货源状态4(数据库中3个值，页面显示有4个值多一个失效,页面上的待交易查询：待交易0且未过期的，数据库中的待交易0包含：过期和未过期的)-------------------------
	...
	//---------------------交易状态7(当前改为5)---------------------------
	//1.货主对交易的操作：状态的改变
	/**交易状态--无效（货主版即导入承运人的司机号为空，订单中driverId为空）- 0*/
	public static final String TRADE_START_INVALID_KEY = "0";
	/**交易状态--无效（货主版即导入承运人的司机号为空，订单中driverId为空）*/
	public static final String TRADE_START_INVALID_VALUE = "待交易";
...
//	public static final String TRADE_START_AFTER_LOADING_VALUE = "待装货";
	...
	/**交易状态-待评价订单（即已完成且未评价的 数据库中没有该状态）- 8*/
	public static final String TRADE_START_SUCCESS_NOEVALUATE_KEY = "8";
	/**交易状态--待评价订单（即已完成且未评价的 数据库中没有该状态）*/
	public static final String TRADE_START_SUCCESS_NOEVALUATE_VALUE = "待评价";
   ...
   //---------------------总评价得分-----------------------------
	...
	//--------------------交易取消的来源---------------------------------
		...
		/**交易取消的来源-司机取消后，货主取消-3*/
		public static final String TRADE_CANCEL_ORIGIN_OUR_PASSIVE_KEY  = "3";
		/**交易取消的来源-司机取消后，货主取消*/
		public static final String TRADE_CANCEL_ORIGIN_OUR_PASSIVE_VALUE  = "司机取消后,我方取消";
		
		
  //-----------------------------发货单和回单上传表----------------------------------
		/**发货单or回单上传图片-回单上传图片-0**/
		public static final String TYPE_RECEIPT_KEY = "0";
		
		/**发货单or回单上传图片-发货单上传图片-1**/
		public static final String TYPE_SHIPPER_ORDER_KEY = "1";
	...
	/**合同司机*/
	public static final String PACT_DRIVER_MANAGEMENT="a_id_10";
	
	
	/**发货方管理*/
	public static final String MY_DELIVER_MANAGE="a_id_11";
	/**新增发货方管理*/
	public static final String ADD_MY_DELIVER_MANAGE="a_id_12";
	
	/**承运方管理*/
	public static final String MY_ACCEPT_MANAGE="a_id_13";
	/**新增承运方管理*/
	public static final String ADD_MY_ACCEPT_MANAGE="a_id_14";
	
	
	/**收货方管理*/
	public static final String MY_TAKE_DELIVER_MANAGE="a_id_15";
	/**新增收货方管理*/
	public static final String ADD_MY_TAKE_DELIVER_MANAGE="a_id_16";
