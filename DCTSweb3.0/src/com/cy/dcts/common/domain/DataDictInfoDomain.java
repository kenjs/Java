...
public class DataDictInfoDomain implements Serializable {
	...
	private List<DictInfo> tradeStartData=DataDictUtil.tradeStartData();
	...
	public List<DictInfo> getTradeStartData() {
		return tradeStartData;
	}

	public void setTradeStartData(List<DictInfo> tradeStartData) {
		this.tradeStartData = tradeStartData;
	}
