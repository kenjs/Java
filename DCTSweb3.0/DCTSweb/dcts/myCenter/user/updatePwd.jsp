...
<script src="<sys:context/>/resource/js/mycenter/updatepwd.js"></script>
...
<div class="mian">
    ...
    <div class="fr sonafr">
       ...
       <!--2.填写修改密码-->
       <div class="laing two_laing" id="new_pwd" style="display: none;">
        <ul>
          <li class="state"><label>填写新密码&nbsp;:</label><input name="password" type="password" class="int m3" /></li>
          <li>
            <label>确认密码&nbsp;:</label><input name="re_password" type="password" class="int m3" />
          </li>
          <li class="ternow mt20">
            <label></label>
      ...
      <div class="laing two_laing" id="complete_fail" style="display: none;">
            ...
            <div class="ternow mtf"><input name="" type="button" value="取消" class="sub subf" /><input name="" type="button" value="重新修改" class="sub" onclick="javascript:window.location.href='<sys:context/>/openUpdatePwdView'"/></div>
       </div>
