...
@Repository
public class HyXydjbdshDaoImp implements HyXydjbdshDao {
	@Autowired
	...
	public List<BaseBusinessDomain> queryList(BaseBusinessDomain baseDomain,UserDomain userDomain)  throws Exception {
		HyXydjbdshDomain domain = (HyXydjbdshDomain) baseDomain;
		...
		// 检索数据
		businessSqlMapClientTemplate.queryForObjectByCurr("queryHyXydjbdshList","dataList",map); 
