...
public class HyFydjshDomain  extends BaseBusinessDomain {
	...
	private Map<String,List<HyFydjshDomain>> map;
	
	private String rqQ;
	private String rqZ;
	private String shbz;//审核标志

	public HyFydjshDomain() {
	}
	...
	public Map<String, List<HyFydjshDomain>> getMap() {
		if(null==map)
			map=new HashMap<String, List<HyFydjshDomain>>();
		return map;
	}


	public void setMap(Map<String, List<HyFydjshDomain>> map) {
		this.map = map;
	}
