...
/**
 * The DOMAIN class FOR CW_ZJRB is created by tools.
 * @author HJH
 */

public class CwZjrbDomain  extends BaseBusinessDomain {
	...
	private String bz; 		                         //收支标志（1 收入 2支出）
	
	private String sm;
	
	private List<BaseBusinessDomain> dataList; 		 //查询列表
	private List<CwZjrbSzmxDomain> szMxList; 		 //查询列表

	private CwQtsrDomain qtsrDomain;
	...
	public CwQtsrDomain getQtsrDomain() {
		if(qtsrDomain==null){
			qtsrDomain=new CwQtsrDomain();
		}
		return qtsrDomain;
	}

	public void setQtsrDomain(CwQtsrDomain qtsrDomain) {
		this.qtsrDomain = qtsrDomain;
	}
	...
	public List<CwZjrbSzmxDomain> getSzMxList() {
		if(szMxList==null){
			szMxList=new ArrayList<CwZjrbSzmxDomain>();
		}
		return szMxList;
	}

	public void setSzMxList(List<CwZjrbSzmxDomain> szMxList) {
