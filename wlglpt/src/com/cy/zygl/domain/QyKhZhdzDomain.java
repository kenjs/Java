...
/**
 * The DOMAIN class FOR QY_KH_ZHDZ is created by tools.
 * @author HJH
 */

public class QyKhZhdzDomain  extends BaseBusinessDomain {
	//default serial version id, required for serializable classes.
	private static final long serialVersionUID = 1L;
	private String zhdzDjxh;                         // 装货地址登记序号
