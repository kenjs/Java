...
/**
 * The DOMAIN class FOR QY_XXZJ_DJXX is created by tools.
 * @author HJH
 */

public class QyXxzjDjxxDomain  extends BaseBusinessDomain {
	...
	private String qhStr;                           //行政区划
	
	private String xzqhMc; 
	
	private List<BaseBusinessDomain> dataList; 		 //查询列表

	public QyXxzjDjxxDomain() {
	}
	...
	public String getQhStr() {
		return qhStr;
	}

	public void setQhStr(String qhStr) {
		this.qhStr = qhStr;
	}
