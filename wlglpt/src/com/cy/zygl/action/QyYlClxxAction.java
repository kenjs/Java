...
import com.cy.zygl.service.QyYlClxxService;
 ...
 */
 @Controller
@Scope("prototype")
@Action(value = "/zygl/qyylclxx", results = {
		@Result(name = "init", location = "/work/zygl/qyylclxx.jsp"),
		@Result(name = "query", type = "json"),
		@Result(name = "initMx", location = "/work/zygl/qyylclxx_mx.jsp"),
		@Result(name = "save", type = "json"),
		@Result(name = "delete", type = "json"),
		@Result(name = "deleteSjxx",type = "json")})
@SuppressWarnings("unchecked")
public class QyYlClxxAction extends ExtendAction {
	...
	public String deleteSjxx() throws Exception {
		((QyYlClxxService)getService()).deleteSjxx(getDomain());
		return "deleteSjxx";
	}
	...
	@Resource(name = "qyYlClxxServiceImp")
