...
@Controller
@Scope("prototype")
@Action(value = "/jcgl/shhwhz", results = {
		@Result(name = "init", location = "/work/jcgl/jc_shhwhz.jsp"),
		@Result(name = "query", location = "/work/jcgl/jc_shhwhz.jsp"),
		@Result(name = "initMx", location = "/work/jcgl/jc_pcxxcx_mx.jsp")
		})
@SuppressWarnings("unchecked")
public class JcShHwHzAction extends ExtendAction {
	...
	@Resource(name = "jcShHwHzServiceImp")
