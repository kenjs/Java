...
@Controller
@Scope("prototype")
@Action(value = "/jcgl/khshmx", results = {
		@Result(name = "init", location = "/work/jcgl/jc_khshmx.jsp"),
		@Result(name = "query", location = "/work/jcgl/jc_khshmx.jsp"),
		@Result(name = "initMx", location = "/work/jcgl/jc_pcxxcx_mx.jsp")
		})
@SuppressWarnings("unchecked")
public class JcKhShMxAction extends ExtendAction {
	...
	@Resource(name = "jcKhShMxServiceImp")
