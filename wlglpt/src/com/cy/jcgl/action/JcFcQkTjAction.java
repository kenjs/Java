...
@Controller
@Scope("prototype")
@Action(value = "/jcgl/fcqktj", results = {
		@Result(name = "init", location = "/work/jcgl/jc_fcqktj.jsp"),
		@Result(name = "query", location = "/work/jcgl/jc_fcqktj.jsp"),
		@Result(name = "initMx", location = "/work/jcgl/jc_pcxxcx_mx.jsp")
		})
@SuppressWarnings("unchecked")
public class JcFcQkTjAction extends ExtendAction {
	...
	@Resource(name = "jcFcQkTjServiceImp")
