 ...
 */
@Repository
public class JcShHwHzDaoImp extends ExtendDaoImp implements JcShHwHzDao {
	@Autowired
	...
	public List<BaseBusinessDomain> queryList(BaseBusinessDomain baseDomain) throws Exception {
		JcShHwHzDomain domain=(JcShHwHzDomain)baseDomain;
		...
		map.put("tjRq", domain.getTjRq());
		map.put("kh", domain.getFhrDjxh());
		map.put("dataList", dataList);
		
		//businessSqlMapClientTemplate.queryForObjectByCurr("queryShHwHzList", "dataList", map);
		//String mc=(String)businessSqlMapClientTemplate.queryForObject("selectQyZzGjMcByJgbm",map);
		domain.setJgMc(SysEncodeUtil.UTF82GBK(domain.getFhrMc()));
