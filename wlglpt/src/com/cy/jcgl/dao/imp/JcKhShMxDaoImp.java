 ...
 */
@Repository
public class JcKhShMxDaoImp extends ExtendDaoImp implements JcKhShMxDao {
	@Autowired
	...
	public List<BaseBusinessDomain> queryList(BaseBusinessDomain baseDomain) throws Exception {
		JcKhShMxDomain domain=(JcKhShMxDomain)baseDomain;
		...
		businessSqlMapClientTemplate.queryForObjectByCurr("queryKhShMxList", "dataList", map);
