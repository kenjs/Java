...
@Controller
@Scope("prototype")
@Action(value = "bggl/bgxbqt", 
		results = {
		@Result(name = "initMx", location = "/work/bggl/bggl_xbqt_mx.jsp"),
		@Result(name = "init", location = "/work/bggl/bggl_xbqt.jsp"),
		@Result(name = "query", type = "json"),
		@Result(name = "save", type = "json"),
		@Result(name = "delete", type = "json")})
public class BgXbqtAction extends ExtendAction {
	...
	@Resource(name = "bgXbqtServiceImp")
