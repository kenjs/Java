...
/**
 * 
* @Descriptoin 输出代码-物流损失处理方式下拉列表
* @Note
* @author HJH
* @version
 */

public class DmWlssclfsTag extends TagSupport {
	...
	public int doEndTag() {
		try {
			...
			List<DmbGgDomain> dataList = sqlMapClientTemplate.queryForList("getWlssclfsDdlbList");
