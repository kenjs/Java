...
/**
 * 
* @Descriptoin 包装计量单位下拉列表
* @Note
* @author admin
* @version
 */

public class QyBzJldwTag extends TagSupport {
	...
	public int doEndTag() {
		try {
			...
			List<DmbGgDomain> dataList = businessSqlMapClientTemplate.queryForList("getQyBzJldwDdlbList", map);
