...
/**
 * 
* @Descriptoin 输出代码-待结算数据来源下拉列表
* @Note
* @author HJH
* @version
 */

public class DmDjsSjlyTag extends TagSupport {
	...
	public int doEndTag() {
		try {
			...
			List<DmbGgDomain> dataList = sqlMapClientTemplate.queryForList("getDjsSjlyDdlbList");
