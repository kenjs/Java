...
/**
 * 
* @Descriptoin 权限机构下的所有公司下拉列表
* @Note
* @author admin
* @version
 */

public class QxGsListTag extends TagSupport {
	...
	public int doEndTag() {
		try {
			...
			List<DmbGgDomain> dataList = businessSqlMapClientTemplate.queryForList("getQxGsDdlbList", map);
