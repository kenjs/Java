...
/**
 * 
* @Descriptoin 输出代码-支付方式下拉列表
* @Note
* @author HCM
* @version
 */

public class DmZffsTag extends TagSupport {
	...
	private String khysBz;
	private boolean contaisQxz;//请选择
	private String onChange;//请选择
	@Autowired
	...
	public int doEndTag() {
		try {
			...
			List<DmbGgDomain> dataList = sqlMapClientTemplate.queryForList("getZffsDdlbList");
			if(!"Y".equals(khysBz)){
			   dataList.remove(3);
			}
	...
	public String getKhysBz() {
		return khysBz;
	}

	public void setKhysBz(String khysBz) {
		this.khysBz = khysBz;
	}
