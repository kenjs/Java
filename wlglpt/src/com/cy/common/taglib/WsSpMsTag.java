...
/**
 * 
* @Descriptoin 单点登录登录方式下拉列表
* @Note
* @author admin
* @version
 */

public class WsSpMsTag extends TagSupport {
	...
	public int doEndTag() {
		try {
			...
			List<DmbGgDomain> dataList = businessSqlMapClientTemplate.queryForList("getSpwsMsDdList", map);
