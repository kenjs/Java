...
/**
 * 
* @Descriptoin 数量计量单位下拉列表
* @Note
* @author admin
* @version
 */

public class QyAllJldwTag extends TagSupport {
	...
	public int doEndTag() {
		try {
			...
			List<DmbGgDomain> dataList = businessSqlMapClientTemplate.queryForList("getQyAllJldwDdlbList", map);
