...
/**
 * 
* @Descriptoin 输出代码-物流损失原因下拉列表
* @Note
* @author HJH
* @version
 */

public class DmWlssyyTag extends TagSupport {
	...
	public int doEndTag() {
		try {
			...
			List<DmbGgDomain> dataList = sqlMapClientTemplate.queryForList("getWlssyyDdlbList",map);
