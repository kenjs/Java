...
/**
 * 
* @Descriptoin 输出代码-对帐差异处理方式下拉列表
* @Note
* @author HJH
* @version
 */

public class DmDzcyClfs3Tag extends TagSupport {
	...
	public int doEndTag() {
		try {
			...
			List<DmbGgDomain> dataList = sqlMapClientTemplate.queryForList("getDzcyClfs3DdlbList");
