...
/**
 * 
* @Descriptoin 体积计量单位下拉列表
* @Note
* @author admin
* @version
 */

public class QyTjJldwTag extends TagSupport {
	...
	public int doEndTag() {
		try {
			...
			List<DmbGgDomain> dataList = businessSqlMapClientTemplate.queryForList("getQyTjJldwDdlbList", map);
