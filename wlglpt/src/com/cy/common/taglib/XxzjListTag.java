...
/**
 * 
* @Descriptoin 当前公司下的信息中介下拉列表
* @Note
* @author admin
* @version
 */

public class XxzjListTag extends TagSupport {
	...
	public int doEndTag() {
		try {
			...
			map.put("ssJgbm", userDomain.getGsbm());
			map.put("mcContainDmBz", mcContainDmBz);
			List<DmbGgDomain> dataList = businessSqlMapClientTemplate.queryForList("queryXxzjByJgbm", map);
