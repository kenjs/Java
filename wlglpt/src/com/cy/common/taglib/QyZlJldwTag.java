...
/**
 * 
* @Descriptoin 重量计量单位下拉列表
* @Note
* @author admin
* @version
 */

public class QyZlJldwTag extends TagSupport {
	...
	public int doEndTag() {
		try {
			...
			List<DmbGgDomain> dataList = businessSqlMapClientTemplate.queryForList("getQyZlJldwDdlbList", map);
			...
			for(Iterator iter=dataList.iterator();iter.hasNext();){
				...
				if(domain.getDm().equals(defaultValue) || domain.getDefaultFlag().equals("Y")){
