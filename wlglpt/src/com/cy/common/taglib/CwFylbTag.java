...
/**
 * 
* @Descriptoin 输出财务-费用类别-维护下拉列表
* @Note
* @author HJH
* @version
 */

public class CwFylbTag extends TagSupport {
	...
	public int doEndTag() {
		try {
			...
			List<DmbGgDomain> dataList = sqlMapClientTemplate.queryForList("getCwFylbDdlbList",map);
