...
/**
 * 
* @Descriptoin 输出企业-车辆型号维护下拉列表
* @Note
* @author HJH
* @version
 */

public class QyClxhwhTag extends TagSupport {
	...
	public int doEndTag() {
		try {
			...
			map.put("gsbm", userDomain.getZgsbm());
			map.put("mcContainDmBz", mcContainDmBz);
			List<DmbGgDomain> dataList = sqlMapClientTemplate.queryForList("getQyClxhwhDdlbList", map);
