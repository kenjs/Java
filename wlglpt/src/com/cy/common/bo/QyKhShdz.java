...
/**
 * The persistent class For QY_KH_SHDZ is created by tools.
 * @author HJH
 */

public class QyKhShdz  implements Serializable {
	...
	private String xxdz;                             // 名称
	private String pyqc;                             // 拼音全称
	private String pyjc;                             // 拼音简称
	private String yb;                               // 邮编
	private String lxr;                              // 简称
	private String lxrYddh;                          // 拼音全称
	private String lxrGddh;                          // 拼音简称
	private String qtlxdh;                           // 地址
	private String bz;                               // 
