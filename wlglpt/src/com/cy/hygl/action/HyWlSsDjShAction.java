 ...
 */
 @Controller
@Scope("prototype")
@Action(value = "/hygl/wlssdjsh", results = {
		@Result(name = "init", location = "/work/hygl/hy_wlssdjsh.jsp"),
		@Result(name = "query", type = "json"),
		@Result(name = "initMx", location = "/work/hygl/hy_wlssdjsh_mx.jsp"),
		@Result(name = "save", type = "json"),
		@Result(name = "delete", type = "json")})
@SuppressWarnings("unchecked")
public class HyWlSsDjShAction extends ExtendAction {
	...
	public BaseBusinessDomain getDomain() {
		if (null == domain) {
			domain = new HyWlSsDjShDomain();
		}
		return domain;
	}

	public void setDomain(BaseBusinessDomain domain) {
		this.domain = (HyWlSsDjShDomain) domain;
	}

	@Resource(name = "hyWlSsDjShServiceImp")
