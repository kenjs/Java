...
@Repository
public class HyWlSsDjShDaoImp implements HyWlSsDjShDao {
	@Autowired
	...
	public List<BaseBusinessDomain> queryList(BaseBusinessDomain baseDomain,UserDomain user)  throws Exception {
		HyWlSsDjShDomain domain = (HyWlSsDjShDomain) baseDomain;
		// 分页相关
		...
		// 检索数据
		businessSqlMapClientTemplate.queryForObjectByCurr("queryHyWlSsDjSh", "dataList", map);
