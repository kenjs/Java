...
<script type="text/javascript">
	...
	function onUpdate(ddDjxh,gsbm) {
		var url = jcontextPath + '/hygl/hytydgl!initMx.action?domain.ddDjxh='+ddDjxh;
		if("XH"==gsbm){
			url = jcontextPath + '/hygl/hytydgl!initMxXh.action?domain.ddDjxh='+ddDjxh;
		}
	...
	function onUpdateHw(ddDjxh, xh,gsbm) {
		var url = jcontextPath + '/hygl/hytydgl!initMx.action?domain.ddDjxh='+ddDjxh+'&domain.hwmxDomain.xh='+xh;
		if("XH"==gsbm){
			url = jcontextPath + '/hygl/hytydgl!initMxXh.action?domain.ddDjxh='+ddDjxh+'&domain.hwmxDomain.xh='+xh;
		}
		navigateMenu(url,'托运单修改','true');
	}
	...
	function onRefresh(){
		...
		if(djrCzyDjxh4Query==null||djrCzyDjxh4Query=="undefined"||djrCzyDjxh4Query=='null'){
			djrCzyDjxh4Query="";
		}
		//请求表格数据
	...
	function myGridComplete() {
            ...
            for (var i = 0; i < graduateIds.length; i++) {
                ...
                var gsbm = "<%=qybm%>";
                var link = "<a href=\"javascript:onUpdate('"+val+"','"+gsbm+"')\"><font color=\"blue\">修改</font></a>"
                ...
                var hwLink = "<a href=\"javascript:onUpdateHw('"+val+"','"+xh+"','"+gsbm+"')\"><font color=\"blue\">"+hwmc+"</font></a>";
