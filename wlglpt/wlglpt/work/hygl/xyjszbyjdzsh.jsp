...
<script type="text/javascript">
	...
	function onRefresh(){
		...
		//请求表格数据
		var url = jcontextPath+"/cwgl/xyjszbyjdzsh!query.action";   
	...
	function initDataGrid(){ 
		  $("#dataList").jqGrid({
		    ...
		    shrinkToFit:false, 
		    colNames:['序号','<input title="选中/取消选中" type="checkbox"  onclick="checkBoxAll(event,this,\'xhs\');" />','操作',
		            '标志','发送人','发送日期',"文书审批序号","审批序号","jdxh",
		            '所属机构','派车单号','派车登记序号','派车日期','货物名称','分包商类别','分包商',
				    '月结','对账金额','对帐人','对帐日期','差异金额'
		              ],			 //name 列显示的名称
		    ...
		    jsonReader: {     
	     	 	root: 	 "domain.shList",   				// 数据行（默认为：rows）
	...
	function myGridComplete() {
            ...
            for (var i = 0; i < graduateIds.length; i++) {
              ...
              if(fsthbz=='1'){
                ...
                $("#dataList").jqGrid('setRowData', cl, { 'xh': i+1 });
