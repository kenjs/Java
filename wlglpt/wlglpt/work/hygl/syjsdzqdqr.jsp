...
<script type="text/javascript">
    ...
    function onConfirm(qdDjxh) {
    	var url = jcontextPath+"/hygl/xyjssrdzqd!initSydzqdQrMx?domain.qdDjxh="+qdDjxh;
	...
	function onRefresh(){
		...
		//请求表格数据
		var url = jcontextPath+"/hygl/xyjssrdzqd!querySydzqdConf";   
		 $("#dataList").jqGrid("setGridParam",{
		 	url:url,
		 	datatype:'json',
		 	postData:{"domain.rqQ":encodeURI(rqQ),"domain.rqZ":encodeURI(rqZ),"domain.fylbDm":fylbDm}								//请求的参数，json格式
		 }
	...
	function initDataGrid(){ 
		  $("#dataList").jqGrid({
		    ...
		    shrinkToFit:false, 
		    colNames:['操作', '清单登记序号','清单名称','上游单位','合计金额','对账金额','差异金额',
				     '','状态','意见'],			 //name 列显示的名称
		    ...
		    colModel :[ 
		      ...
		      {name:'qdmc', index:'qdmc', width:'150', align:'center'}, 
		      ...
		      {name:'zt', index:'zt', width:'0', align:'center',hidden:true},
		  ...
		  $("#dataList").jqGrid('navButtonAdd','#pager',{
		       ...
		       onClickButton : function () { 
		       	   $("#mainForm").attr("action",jcontextPath+"/hygl/sydzqdqr!download");
				   $("#mainForm").submit();
		       } 
		 });
	...
	function myGridComplete() {
            ...
            for (var i = 0; i < graduateIds.length; i++) {
                ...
                var link = "<a href=\"javascript:onView('"+val+"')\"><font color=\"blue\">查看</font></a>"
                + " <a href=\"javascript:onConfirm('"+val+"')\"><font color=\"blue\">确认</font></a>";
                if(zt == '3'){
                	link = "<a href=\"javascript:onView('"+val+"')\"><font color=\"blue\">查看</font></a>";
                }
                if(zt == '2'){
                	var ztStr = "";
                	$("#dataList").jqGrid('setRowData', cl, { 'ztStr': ztStr }); 
                }
...
<s:form action="xyjssrdzqd!query" namespace="/hygl" method="post" id="mainForm" name="mainForm">
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td width="8%" align="right">费用类别：</td>
			<td colspan="3">
