...
<script type="text/javascript">
	...
	function initWfhDataGrid(){ 
	  $("#wfhList").jqGrid({
	    ...
	    shrinkToFit:false, 
	    colNames:['序号','订单登记序号','货物顺序号','未发货登记序号', '订单编号','客户名称','<input title="选中/取消选中" type="checkbox" onclick="checkAllJGridChk(event,this,\'wfhXhs\');" />',
	    		  '货物名称','始发地','目的地','包装','类别','结算数量','数量','重量','体积','数量','重量','体积',
	    		  '收入','到付','提货付','货到付',
