...
<script type="text/javascript">
	...
	function initDataGrid(){ 
		  $("#dataList").jqGrid({
		    ...
		    shrinkToFit:false, 
		    colNames:['操作', '开票申请登记序号','客户登记序号','客户名称','申请开票金额','申请开票日期',
		             '开票状态','开票金额','开票日期','核销标志','核销金额',
				     '登记人','登记日期','登记部门','所属单位'],			 //name 列显示的名称
	...
	function myGridComplete() {
            ...
            for (var i = 0; i < graduateIds.length; i++) {
                ...
                var link = "<a href=\"javascript:onUpdate('"+val+"','"+khDjxh+"')\"><font color=\"blue\">核销</font></a>";
