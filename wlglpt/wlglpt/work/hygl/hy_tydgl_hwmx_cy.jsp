...
<script type="text/javascript">
	...
	$(function(){
	   ...
	   initXzqhInputSel();
		...
		$("#kpbz").click(function(){
			if($("#kpbz")[0].checked){
				var sl = trim($("#mainForm_domain_hwmxDomain_sl").val());
				if(sl==""||isNaN(sl)){
					showAlert("请正确输入税率！")
					$("#kpbz").removeAttr("checked");
				}else{
					/*flag1=0;
					flag2=0;
					flag3=0;
					flag4=0;*/
					var srHj = trim($("#mainForm_domain_srHj").val())/1;
					$("#mainForm_domain_srHj").val((srHj/(1-sl/100)). toFixed(2));
				}
			}
		});
		/*$("#mainForm_domain_srHj").change(function(){
			flag1=0;
			flag2=0;
			flag3=0;
			flag4=0;
	...
	<s:hidden name="hwmcData"></s:hidden>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="poptabinfo_css">
      			<tr>
      				...
      				<td width="5%" class="td_noborder"></td>
      				<td width="2%" class="td_noborder"></td>
					<td width="7%" class="td_noborder"></td>
      			</tr>
      		   ...
      		   <tr>
  				...
  				<td >
  					<s:textfield name="domain.hwmxDomain.srBjf" cssClass="pop_input inputright noborder bgstyle_optional srHjJs" ></s:textfield>
  				</td>
  				<td align="right"  class="jsfsChanged">总收入：</td>
  				<td class="jsfsChanged"  colspan="3">
  			...
  			<tr>
  				...
  				<td >
  					<s:textfield name="domain.hwmxDomain.sl" cssClass="pop_input inputright noborder bgstyle_optional" ></s:textfield>
  				</td>
  				<td>%</td>
  				<td align="center">
  					开票    <input type="checkbox" id="kpbz"/>
  				</td>
  			</tr>
  			<tr >
