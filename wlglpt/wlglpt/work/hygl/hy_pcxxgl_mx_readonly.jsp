    			...
    			<tr>
    				...
    				<td>
    					<select name="domain.clsxDm" id="mainForm_domain_clsxDm" onchange="changeClxx();" class="select">
    						<option value="1"  <s:if test="domain.clsxDm==1">selected="selected"</s:if>>自营车辆</option>
    						<option value="2" <s:if test="domain.clsxDm==2">selected="selected"</s:if>>社会车辆</option>
    					</select>
    				</td>
