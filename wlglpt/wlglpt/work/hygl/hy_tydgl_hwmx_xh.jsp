...
<script type="text/javascript">
	...
	function emptyForm() {
		...
		$("#mainForm_domain_hwmxDomain_hwhh").val(s);
	}
	function doSrHjJs() {
	...
	<s:hidden name="hwmcData"></s:hidden>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="poptabinfo_css">
      			...
      			<tr>
      				...
      				<td>
      					<s:textfield name="domain.hwmxDomain.hwhh" cssClass="pop_input inputright noborder bgstyle_optional" ></s:textfield>
      				</td>
      		   </tr>
      		   <tr>
  			...
  			<tr>
  				...
  				<td >
  					...
  					<s:select list="#{'0.004':' 千分之四','0.002':' 千分之二','0.005':' 千分之五','0.010':' 千分之十' }" id="bjbl" cssClass="select bjjs" cssStyle="display:none;"></s:select>
  				</td>
  			</tr>
  			<tr >
