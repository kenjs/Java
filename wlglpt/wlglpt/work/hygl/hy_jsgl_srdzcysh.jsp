...
<script type="text/javascript">
	...
	function onRefresh(){
		...
		//请求表格数据
		var url = jcontextPath+"/hygl/srdzcysh!query.action";   
	...
	function initDataGrid(){ 
	  $("#dataList").jqGrid({
	    ...
	    colNames:['序号','文书审批序号','审批序号','节点序号','<input title="选中/取消选中" type="checkbox" onclick="checkAllJGridChk(event,this,\'xhs\');" />',
	    		'操作','标志','发送人','发送日期','差异金额','审批人','审批日期','审批结果',
	    		'ddDjxh','订单编号','客户名称','货物名称','始发地','目的地','结算数量','发货人地址','收货人地址'
	    		],			 //name 列显示的名称
	    ...
	    colModel :[
		  ...
		  {name:'dzcyje', index:'dzcyje', width:'60', sortable:false, align:'center', 
			cellattr: function(rowId, tv, rawObject, cm, rdata) {
	...
	function myGridComplete() {
	    ...
	    for (var i = 0; i < graduateIds.length; i++) {
	        ...
	        var ddbh = jQuery("#dataList").jqGrid('getCell', cl,"ddbh");
 	        ...
 	        var ddbhStr="<a href=\"javascript:onViewDdMx("+ddDjxh+")\"><font color=\"blue\">"+ddbh+"</font></a>";
 	        $("#dataList").jqGrid('setRowData', cl, { 'ddbh': ddbhStr });
	   ...
	   var gridName = "dataList";
		   var a = ['xh','wsspxh','spxh','jdxh','hstoperationcol','checkboxoperationcol','fsthbz','fsrmc','fsrq','spjzsj','cqbz','dzcyje','sprmc','sprq','spjg'];
...
<body>
<s:form action="srdzcysh!query" namespace="/hygl" method="post" id="mainForm" name="mainForm">
