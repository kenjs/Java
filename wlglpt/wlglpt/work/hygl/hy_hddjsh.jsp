...
<script type="text/javascript">
	...
	function onRefresh(){
		...
		//请求表格数据
		var url = jcontextPath+"/hygl/hyhddjbdsh!query.action";   
	...
	function myGridComplete() {
            ...
            for (var i = 0; i < graduateIds.length; i++) {
               ...
               if(radio=='N'){
            	   ...
            	   var link = "<a href=\"javascript:onWlSsSh('"+wsspxh+"','"+spxh+"')\"><font color=\"blue\">审核</font></a>";
               }
               else{
            	   input = "<input type=\"checkbox\" name=\"xhs\" disabled=\"disabled\" value=\""+wsspxh+"#"+spxh+"#"+jdxh+"\" />";
		           $("#dataList").jqGrid('setRowData', cl, { 'checkbox': input });
            	   
            	   var link = "<a href=\"javascript:onWlSsSh('"+wsspxh+"','"+spxh+"')\"><font color=\"blue\">查看</font></a>";
               }
              if(fsthbz=='1'){
		   ...
		   <table width="95%" border="0" cellspacing="0" cellpadding="0">
		        <tr>
			          <td width="25%" align="left">
			            &nbsp;&nbsp;&nbsp;&nbsp;
			          	<s:radio name="domain.shbz" list='#{"N":"未审核","Y":"已审核"}' listKey="key" listValue="value" onclick="onDisplay()"></s:radio>
			          </td>
