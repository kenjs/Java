...
<script type="text/javascript">
	...
	function YesQd(){
		var sj=$("#mainForm_domain_sbSj").val();
		var url=jcontextPath+"/bggl/bgsbqd!save";
		var obj={"domain.sbSj":sj}
	...
	function onRefresh(){
		 //请求表格数据
			var start=$("#startTime").val();
			var end=$("#endTime").val();
			var url=jcontextPath+"/bggl/bgsbqd!query.action"   
	...
	function initDataGrid(){ 
		  $("#dataList").jqGrid({
		    ...
		    shrinkToFit:false, 
		    colNames:['序号','ID','日期','应签到时间','实际签到时间',
		    		  '是否迟到'],			 //name 列显示的名称
		  ...
		  $("#dataList").jqGrid('navButtonAdd','#pager',{
		       ...
		       onClickButton : function () { 
		       	   $("#mainForm").attr("action",jcontextPath+"/bggl/bgsbqd!download");
				   $("#mainForm").submit();
		       } 
		 });
...
<s:form action="bgsbqd!query" namespace="" method="post" id="mainForm"
	...
	<ul class="lcont">
		...
		<li><a href="#" id="addBtn" class="licon01">签 到</a></li>
	...
	<s:hidden name="domain.sbSj"></s:hidden>
	<div id="divQuery">
	<fieldset>

	<table width="60%" border="0" cellspacing="0" cellpadding="0">
		<tr align="center">
			<td width="12%" align="left">&nbsp;&nbsp;&nbsp;今日签到状态：</td>
			<td width="8%" align="center">应签到时间：</td>
			<td width="8%" align="left"><s:property value="domain.sbSj" /></td>
			<td width="8%" align="center">实际签到时间：</td>
			<td width="10%" align="left"><s:property value="domain.sjSbSj" /></td>
		</tr>
	</table>
	...
	<table width="95%" border="0" align="center" cellspacing="0"
		...
		<tr>
			...
			<td width="35%"><input class="ymdate" name="domain.startTime"
				id="startTime" type="text"
				value="<s:property value="domain.oldDate"/>" /> ～<input
				class="ymdate" id="endTime" type="text" name="domain.endTime"
