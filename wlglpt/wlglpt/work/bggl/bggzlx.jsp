...
<script type="text/javascript">
	$(document).ready(function(){
			...
			$("#addBtn").click(function(){
				var url = jcontextPath+"/bggl/bggzlx!initMx.action";
		    	...
		    	onRefresh();
				//openWindowToDialog(jcontextPath+"/bggl/bggzlx!initMx",760,550);
			});
			//初始化表格
			initDataGrid();
	...
	function onRefresh(){
		 ...
		 var rqZ = $("#rqZId").val(); 
		//请求表格数据
		var url = jcontextPath+"/bggl/bggzlx!query.action";   
	...
	function initDataGrid(){ 
		  $("#dataList").jqGrid({
		    ...
		    shrinkToFit:false, 
		    colNames:['操作', '主题','发送人','发送时间','主键'],			 //name 列显示的名称
		    ...
		    sortname: 'GZLX_XH',				//默认排序 可以是列名称或者是一个数字，这个参数会被提交到后台
		  ...
		  $("#dataList").jqGrid('navButtonAdd','#pager',{
		       ...
		       onClickButton : function () { 
		       	   $("#mainForm").attr("action",jcontextPath+"/bggl/bggzlx!download");
				   $("#mainForm").submit();
		       } 
		 });
	...
	function myGridComplete() {
            ...
            for (var i = 0; i < graduateIds.length; i++) {
                ...
                var link = "<a href=\"javascript:onUpdate('"+val+"')\"><font color=\"blue\">查看</font></a>"
...
<body>
<s:form action="bggzlx!query" namespace="/bggl" method="post" id="mainForm" name="mainForm">
