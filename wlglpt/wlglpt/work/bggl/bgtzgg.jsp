...
<script type="text/javascript">
	...
	function onDelete( tzggXh){
		keyValue = tzggXh;
		showConfirm("您确定要删除该通知公告吗？","yesCallBack");
	}	
	...
	function onRefresh(){
		...
		var url = jcontextPath+"/bggl/bgtzgg!query.action";   
		 $("#dataList").jqGrid("setGridParam",{
		 	...
		 	datatype:'json',
		 	postData:{
				      "domain.zt":encodeURI(zt),"domain.rqQ":rqQ,"domain.rqZ":rqZ}								//请求的参数，json格式
		 }
	...
	function initDataGrid(){ 
		  $("#dataList").jqGrid({
		    ...
		    sortname: 'TZGG_XH',				//默认排序 可以是列名称或者是一个数字，这个参数会被提交到后台
	...
	function myGridComplete() {
            ...
            for (var i = 0; i < graduateIds.length; i++) {
                ...
                var val = jQuery("#dataList").jqGrid('getCell', cl,"tzggXh"); 	  //获取当前单元格里面的登记序号 
