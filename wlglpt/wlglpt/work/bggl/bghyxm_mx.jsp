...
<script type="text/javascript">
	$(function(){
		...
		$("#saveBtn").click(function(){
			...
			var url = jcontextPath+"/bggl/bghyxm!save";  
	...
	function checkdata(){
		var controlNameArray = ["domain.jgbm",
		                        "domain.ly","domain.zt","domain.xjgxbz"];
		var labelNameArray = ["发布范围",
		                      "来源","主题","下级共享"];
	...
	function deleteFj(fjxh,divId){
	    ...
	    $("#"+divId).remove();
	    var url = jcontextPath+"/bggl/bghyxm!deleteFj.action";  
	  	var jsonObj = {"domain.hyxmDjxh":hyxmDjxh,"domain.xh":fjxh};   			
