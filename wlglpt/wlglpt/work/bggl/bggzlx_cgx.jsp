...
<script type="text/javascript">
	...
	function onRefresh(){
		 ...
		 var rqZ = $("#rqZId").val(); 
		//请求表格数据
		var url = jcontextPath+"/bggl/bggzlx!queryForCgx.action";   
	...
	function initDataGrid(){ 
		  $("#dataList").jqGrid({
		    ...
		    shrinkToFit:false, 
		    colNames:['操作', '主题','创建人','创建日期','修改人','修改日期','主键'],			 //name 列显示的名称
		  ...
		  $("#dataList").jqGrid('navButtonAdd','#pager',{
		       ...
		       onClickButton : function () { 
		       	   $("#mainForm").attr("action",jcontextPath+"/bggl/bggzlx!downloadForCgx");
				   $("#mainForm").submit();
		       } 
		 });
...
<body>
<s:form action="bggzlx!queryForCgx" namespace="/bggl" method="post" id="mainForm" name="mainForm">
