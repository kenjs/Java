...
<script type="text/javascript">
	$(function(){
		...
		$("#saveBtn").click(function(){
			...
			var url = jcontextPath+"/bggl/bgtzgg!save";  
	...
	function checkdata(){
		var controlNameArray = ["domain.jgbm","domain.xjgxbz","domain.zt"];
		var labelNameArray = ["发布范围","下级共享","主题"];
		var compareValueArray = [16,1,200];
	...
	function deleteFj(fjxh,divId){
	    ...
	    $("#"+divId).remove();
	    var url = jcontextPath+"/bggl/bgtzgg!deleteFj";  
	  	var jsonObj = {"domain.tzggXh":tzggXh,"domain.xh":fjxh};   			
		...
		<div class="pop_contc" style="height:320px; overflow:auto;">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="poptabinfo_css">
				<tr>
      			...
      			<tr>
      				<td width="15%" align="center"><font class="font_red">*</font>主题</td>
      				<td width="85%" colspan="3">
      					<s:textfield name="domain.zt" cssClass="pop_input_colspan2 noborder bgstyle_required" ></s:textfield>
      				</td>
      			</tr>
      			<tr>
      				<td align="center">内容</td>
      				<td colspan="3">
      					<s:textarea name="domain.nr" rows="4" cssClass="pop_textarea_colspan2 noborder bgstyle_optional" ></s:textarea>
      				</td>
      			</tr>
      			<tr>
