...
<script type="text/javascript">
	...
	function onRefresh(){
		...
		var url = jcontextPath+"/bggl/bggzsj!query.action";   
		 $("#dataList").jqGrid("setGridParam",{
		 	url:url,
		 	datatype:'json',
		 	postData:{"domain.jgbm":jgbm,"domain.yxqZ":yxqZ}								//请求的参数，json格式
		 }
	...
	function initDataGrid(){ 
		  $("#dataList").jqGrid({
		    ...
		    shrinkToFit:false, 
		    colNames:['操作', '机构编码','状态','有效期起','有效期止','上午上班时间','下午下班时间','上午上班时间-时','上午上班时间-分',
				     '下午下班时间-时','下午下班时间-分','创建人','创建日期','修改人',
				     '修改日期'],			 //name 列显示的名称
		    ...
		    sortname: 'yxq_Q',				//默认排序 可以是列名称或者是一个数字，这个参数会被提交到后台
	...
	function myGridComplete() {
            ...
            for (var i = 0; i < graduateIds.length; i++) {
                ...
                var link = "<a href=\"javascript:onUpdate('"+val+"','"+val2+"')\"><font color=\"blue\">修改</font></a>"
                + " <a href=\"javascript:onDelete('"+val+"','"+val2+"')\"><font color=\"blue\">删除</font></a>";
                $("#dataList").jqGrid('setRowData', cl, { 'hstoperationcol': link }); 
                
                var zt = jQuery("#dataList").jqGrid('getCell', cl,"zt"); 
                var link2 = "";
                if("1"==zt){
                	link2 = "<font color=\"red\">失效</font>"
                }else{
                	link2 = "有效"
                }
