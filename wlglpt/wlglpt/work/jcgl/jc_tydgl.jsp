...
<script type="text/javascript">
	...
	function initDataGrid(){ 
		  $("#dataList").jqGrid({
		    ...
		    shrinkToFit:false, 
		    colNames:['序号', '订单登记序号','订单编号','下单日期', '发货单位','结算标志',
		  ...
		  $("#dataList").jqGrid('navButtonAdd','#pager',{
		       ...
		       onClickButton : function () { 
		       	   $("#mainForm").attr("action",jcontextPath+"/jcgl/jctydgl!download.action");
				   $("#mainForm").submit();
		       } 
		 });
	...
	function myGridComplete() {
       ...
       for (var i = 0; i < graduateIds.length; i++) {
           ...
           var ddDjxh = jQuery("#dataList").jqGrid('getCell', cl,"ddDjxh"); 	  //获取当前单元格里面的登记序号
           var ddbh = jQuery("#dataList").jqGrid('getCell', cl,"ddbh");
           var link = "<a href=\"javascript:onView('"+ddDjxh+"')\"><font color=\"blue\">"+ddbh+"</font></a>";
           $("#dataList").jqGrid('setRowData', cl, { 'ddbh': link }); 
       }
...
<body>
<s:form action="jctydgl!query" namespace="/jcgl" method="post" id="mainForm" name="mainForm">
		...
		<fieldset>
		   ...
		   <table width="99%" border="0" cellspacing="0" cellpadding="0">
		        ...
		        <tr>
		          ...
		          <td width="20%"><s:textfield name="domain.hwMc4" cssClass="pop_input noborder inputext bgstyle_optional" ></s:textfield></td>
	        	  <td width="10%" align="right">下单日期：</td>
		          <td width="23%"><sys:dateCurrentDayTag myName="domain.xdrqQ" myId="mainForm_domain_xdrqQ" myClass="ymdate" />
	          			～
