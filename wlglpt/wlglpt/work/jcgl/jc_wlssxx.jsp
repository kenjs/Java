...
<script type="text/javascript">
	...
	function initWlssxxDataGrid(){ 
		  $("#wlssList").jqGrid({
		    ...
		    gridComplete: myWlssxxGridComplete,		//表格加载完毕事件
		    shrinkToFit:false, 
		    colNames:['序号','','','','','货物名称','数量','重量','体积','损失数量','损失重量','损失体积','损失金额',
		              '损失来源','审批状态','客户名称','所属机构名称','登记机构名称'],			 //name 列显示的名称
		    ...
		    jsonReader: {     
	     	 	root: 	 "domain.wlssList",   				// 数据行（默认为：rows）
