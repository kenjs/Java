...
<script type="text/javascript">
	...
	printWindow(); */
		...
		$("#queryBtn").click(function(){
			...
			$("#mainForm").attr("action",jcontextPath+"/jcgl/khshmx!query");
			$("#mainForm").submit();
  ...
  <div id="divQuery" class="noprint">
    ...
    <table id="tab1" width="95%" border="0" cellspacing="0" cellpadding="0" class="poptab_css" style="table-layout: fixed">
    	<tr>
    		...
    		<td width="11%" id="content"></td>
    		<td width="9%" id="content"></td>
    		<td width="10%" id="content"></td>
    	...
    	<tr >
    		<td colspan="13" align="center" id="content" class="tab_title"><font size="3">(单位)客户收货明细表</font></td>
    	</tr>
    	
    
    	<tr>
    		<td colspan="13" align="center" id="content">统计日期:<s:property value="domain.rqq" /> ～ <s:property value="domain.rqz" /></td>
    	</tr>
    	<tr>
    		<td width="50%" colspan="8" align="left" style="border-left: white;border-right: white;border-top: white">客户单位：<s:property value="domain.jgMc" /></td>
    	...
    	<tr>
    		...
    		<td width="12%" rowspan="2" align="center">货物名称</td>
    		<td width="6%" rowspan="2" align="center">订单编号</td>
    		<td width="6%" rowspan="2" align="center">下单日期</td>
    		<td width="6%" rowspan="2" align="center">数量</td>
    		<td width="6%" rowspan="2" align="center">重量(吨)</td>
    		<td width="6%" rowspan="2" align="center">体积(方)</td>
    		<td width="6%" colspan="4" align="center">收入</td>
    		<td width="6%" rowspan="2" align="center">始发地</td>
    		<td width="6%" rowspan="2" align="center">目的地</td>
    	</tr>
    	<tr>
