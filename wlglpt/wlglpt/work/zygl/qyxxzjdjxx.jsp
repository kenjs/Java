...
<script type="text/javascript">
	...
	function onRefresh(){
		...
		var url = jcontextPath+"/qyxxzjwh!query.action";   
		 $("#dataList").jqGrid("setGridParam",{
		 	url:url,
		 	datatype:'json',
		 	postData:{"domain.ssJgbm":jgbm,"domain.xxzjmc":encodeURI(zjmc)}								//请求的参数，json格式
		 }
	...
	function initDataGrid(){ 
		  $("#dataList").jqGrid({
		    ...
		    shrinkToFit:false, 
		    colNames:['操作', '行政区划','名称','简称','地址','负责人',
				     '电话','邮编','备注','创建人','创建日期',
				     '修改人','修改日期','ID'],			 //name 列显示的名称
		    ...
		    sortname: 'XXZJ_DJXH',				//默认排序 可以是列名称或者是一个数字，这个参数会被提交到后台
	...
	function myGridComplete() {
            ...
            for (var i = 0; i < graduateIds.length; i++) {
                ...
                var val = jQuery("#dataList").jqGrid('getCell', cl,"xxzjDjxh"); 	  //获取当前单元格里面的登记序号 
		   		...
		   		<table width="99%" border="0" cellspacing="0" cellpadding="0">
		        	<tr>
		        		<td width="10%" align="right">单位：</td>
		          		...
		          		<td width="12%" align="right">信息中介名称：</td>
