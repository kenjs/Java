...
<script type="text/javascript">
	...
	function onRefresh(){
		...
		var url = jcontextPath+"/qyxlwh!query.action";   
		 $("#dataList").jqGrid("setGridParam",{
		 	url:url,
		 	datatype:'json',
		 	postData:{"domain.ssJgbm":sjJgbm}								//请求的参数，json格式
		 }
	...
	function initDataGrid(){ 
		  $("#dataList").jqGrid({
		    ...
		    shrinkToFit:false, 
		    colNames:['操作', '所属机构','始发地','目的地','里程数',
		              '达到天数','创建人','创建日期','修改人','修改日期','','',''],			 //name 列显示的名称
		    ...
		    sortname: 'SS_JGBM',				//默认排序 可以是列名称或者是一个数字，这个参数会被提交到后台
	...
	function myGridComplete() {
            ...
            for (var i = 0; i < graduateIds.length; i++) {
                ...
                var mddXzqhDm = jQuery("#dataList").jqGrid('getCell', cl,"mddXzqhDm"); 	  //获取当前单元格里面的登记序号 
                var link = "<a href=\"javascript:onUpdate('"+val+"','"+sfdXzqhDm+"','"+mddXzqhDm+"')\"><font color=\"blue\">修改</font></a>"
                + " <a href=\"javascript:onDelete('"+val+"','"+sfdXzqhDm+"','"+mddXzqhDm+"')\"><font color=\"blue\">删除</font></a>";
