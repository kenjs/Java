...
<script type="text/javascript">
	...
	function onRefresh(){
		...
		var url = jcontextPath+"/zygl/qykhdjxx!query.action";   
		 $("#dataList").jqGrid("setGridParam",{
		 	url:url,
		 	datatype:'json',
		 	postData:{"domain.ssJgbm":ssJgbm,"domain.djJgbm":bmDjxh,"domain.fhrMc":encodeURI(fhrMc)}								//请求的参数，json格式
		 }
	...
	function initDataGrid(){ 
		  $("#dataList").jqGrid({
		    ...
		    shrinkToFit:false, 
		    colNames:['操作', '客户登记序号','客户名称','客户简称',
				     '行政区划','所属单位','登记部门','地址','负责人','电话',
				     '创建人','创建日期','修改人','修改日期','客户类型','企业客户编码','余款结算方式','拼音全称','拼音简称'],			 //name 列显示的名称
	...
	function myGridComplete() {
            ...
            for (var i = 0; i < graduateIds.length; i++) {
                ...
                var val = jQuery("#dataList").jqGrid('getCell', cl,"khDjxh"); 	  //获取当前单元格里面的登记序号 
