...
<script type="text/javascript">
	...
	function onRefresh(){
		...
		var url = jcontextPath+"/zygl/qyfbsjsjg!query.action";   
		 $("#dataList").jqGrid("setGridParam",{
		 	url:url,
		 	datatype:'json',
		 	postData:{"domain.fbsDjxh":fbsDjxh,"domain.lxDjxh":lxDjxh,"domain.yxqZ":yxqZ}								//请求的参数，json格式
		 }
	...
	function initDataGrid(){ 
		  $("#dataList").jqGrid({
		    ...
		    shrinkToFit:false, 
		    colNames:['操作', '结算价格登记序号(SEQ_ZY_DJXH)','分包商登记序号','状态','始发地','目的地','里程数','达到天数','结算计量单位',
				     '价格计算公式(带参数的公式)','有效期起','有效期止','价格说明','有效期起','有效期止',
				     '有效标志(Y/N)','创建人','创建日期','修改人','修改日期'],			 //name 列显示的名称
		    ...
		    sortname: 'JSJG_DJXH',				//默认排序 可以是列名称或者是一个数字，这个参数会被提交到后台
	...
	function myGridComplete() {
            ...
            for (var i = 0; i < graduateIds.length; i++) {
                ...
                var val = jQuery("#dataList").jqGrid('getCell', cl,"jsjgDjxh"); 	  //获取当前单元格里面的登记序号 
