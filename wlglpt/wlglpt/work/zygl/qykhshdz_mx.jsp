...
<script type="text/javascript">
	$(function(){
	 ...
	 //行政区划input下拉
		...
		$("#saveBtn").click(function(){
			...
			var shdwMc = $("#mainForm_domain_shdwMc").val();
			var shdzDjxh = trim($("#mainForm_domain_shdzDjxh").val()); 
			...
			var url = jcontextPath+"/qykhshdz!save";  
	    	var jsonObj = {"domain.shdzDjxh":shdzDjxh,"domain.shdwMc":shdwMc,"domain.khDjxh":khDjxh,"domain.xzqhDm":xzqhDm,
	...
	function checkdata(){
		var controlNameArray = ["domain.shdwMc","domain.xxdz","domain.fhrXzqhDm","domain.yb","domain.lxr",
		                        "domain.lxrYddh","domain.lxrGddh","domain.qtlxdh","domain.bz"];
		var labelNameArray = ["收货单位","详细地址","行政区划","邮编","联系人",
		                      "移动电话","固定电话","其他电话","备注"];
		var compareValueArray = [100,100,20,10,100,
		                         500,80,100,200];
		...
		var notNullArray = [true,true,true,false,false,
...
<body>
<%try{ %>
<s:form action="qykhshdz!initMx" namespace="/zygl" method="post" id="mainForm" name="mainForm">
	<input type="hidden" id="mainForm_domain_shdzDjxh" value='<s:property value="domain.shdzDjxh"/>'/>
	...
	<div id="maincont">
		<div class="pop_contc" style="height:320px; overflow:auto;">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="poptabinfo_css">
				<tr>
      				<td width="15%" align="right"><font class="font_red">*</font>收货单位：</td>
      				<td width="85%" colspan="3">
      					<s:textfield name="domain.shdwMc" cssClass="pop_input_colspan2 bgstyle_required" ></s:textfield>
      				</td>
      			</tr>
				<tr>
