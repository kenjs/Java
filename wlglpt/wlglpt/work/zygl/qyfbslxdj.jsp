...
<script type="text/javascript">
	...
	function onRefresh(){
		...
		var url = jcontextPath+"/zygl/qyfbslxdj!query.action";   
		 $("#dataList").jqGrid("setGridParam",{
		 	url:url,
		 	datatype:'json',
		 	postData:{"domain.fbsDjxh":fbsDjxh}								//请求的参数，json格式
		 }
	...
	function initDataGrid(){ 
		  $("#dataList").jqGrid({
		    ...
		    shrinkToFit:false, 
		    colNames:['操作', '线路名称','线路简称',
				     '始发地','目的地','备注',
				     '创建人','创建日期','修改人','修改日期','主键'],			 //name 列显示的名称
		    ...
		    sortname: 'LX_DJXH',				//默认排序 可以是列名称或者是一个数字，这个参数会被提交到后台
	...
	function myGridComplete() {
            ...
            for (var i = 0; i < graduateIds.length; i++) {
                ...
                var val = jQuery("#dataList").jqGrid('getCell', cl,"lxDjxh"); 	  //获取当前单元格里面的登记序号 
