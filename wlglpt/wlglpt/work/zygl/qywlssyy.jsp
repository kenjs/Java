   ...
   function startSuccess(){
	...
	function onRefresh(){
		...
		var url = jcontextPath+"/zygl/wlssyy!query.action";   
		 $("#dataList").jqGrid("setGridParam",{
		 	url:url,
		 	datatype:'json',
		 	postData:{"domain.ssyy":encodeURI(ssyy)}								//请求的参数，json格式
		 }
	...
	function initDataGrid(){ 
		  $("#dataList").jqGrid({
		    ...
		    shrinkToFit:false, 
		    colNames:['操作', '所属机构', '物流损失原因', '说明','创建人','创建日期',
		    ...
		    sortname: 'whXh',				//默认排序 可以是列名称或者是一个数字，这个参数会被提交到后台
...
<s:form action="fbsyhgl!query" namespace="/zygl" method="post" id="mainForm" name="mainForm">
	...
	<fieldset>
	   ...
	   <table width="95%" border="0" cellspacing="0" cellpadding="0">
	        <tr>
			<td width="12%" align="right">物流损失原因：</td>
			<td width="30%">
