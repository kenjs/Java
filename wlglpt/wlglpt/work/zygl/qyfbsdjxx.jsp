...
<script type="text/javascript">
	...
	function onRefresh(){
		...
		var url = jcontextPath+"/zygl/qyfbsdjxx!query.action";   
		 $("#dataList").jqGrid("setGridParam",{
		 	url:url,
		 	datatype:'json',
		 	postData:{"domain.ssJgbm":ssJgbm,"domain.fbsmc":encodeURI(fbsmc)}								//请求的参数，json格式
		 }
	...
	function initDataGrid(){ 
		  $("#dataList").jqGrid({
		    ...
		    shrinkToFit:false, 
		    colNames:['操作', '分包商登记序号','行政区划','分包商名称','分包商简称','地址','负责人','电话',
				     '邮编','备注','创建人','创建日期','修改人',
				     '修改日期'],			 //name 列显示的名称
		    ...
		    sortname: 'FBS_DJXH',				//默认排序 可以是列名称或者是一个数字，这个参数会被提交到后台
	...
	function myGridComplete() {
            ...
            for (var i = 0; i < graduateIds.length; i++) {
                ...
                var val = jQuery("#dataList").jqGrid('getCell', cl,"fbsDjxh"); 	  //获取当前单元格里面的登记序号 
	...
	<fieldset>
	   ...
	   <table width="99%" border="0" cellspacing="0" cellpadding="0">
	        <tr>
	          ...
	          <td width="10%" align="right">分包商名称：</td>
