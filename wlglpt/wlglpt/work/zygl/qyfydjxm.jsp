...
<script type="text/javascript">
	$(document).ready(function(){
			...
			$("#addBtn").click(function(){
				var url = jcontextPath+"/zygl/qyfydjxm!initMx.action";
    ...
    function onUpdate(whXh){
    	var url = jcontextPath+"/zygl/qyfydjxm!initMx.action?domain.whXh="+whXh;
	...
	function yesCallBack(){
		 ...
		 var url = jcontextPath+"/zygl/qyfydjxm!delete";   
	...
	function onRefresh(){
		...
		//请求表格数据
		var url = jcontextPath+"/zygl/qyfydjxm!query.action";   
		 $("#dataList").jqGrid("setGridParam",{
		 	url:url,
		 	datatype:'json',
		 	postData:{"domain.fydjXmmc":encodeURI(fydjXmmc),"domain.clsxDm":clsxDm}								//请求的参数，json格式
		 }
	...
	function initDataGrid(){ 
		  $("#dataList").jqGrid({
		    ...
		    shrinkToFit:false, 
		    colNames:['操作', '维护序号(SEQ_ZY_DJXH)','费用登记项目名称','车辆属性','说明','创建人',
		    ...
		    colModel :[ 
		      ...
		      {name:'fydjXmmc', index:'fydjXmmc', width:'150', align:'center'}, 
		      {name:'clsxMc', index:'clsxMc', width:'100', align:'center'},
		  ...
		  $("#dataList").jqGrid('navButtonAdd','#pager',{
		       ...
		       onClickButton : function () { 
		       	   $("#mainForm").attr("action",jcontextPath+"/zygl/qyfydjxm!download");
				   $("#mainForm").submit();
		       } 
		 });
...
<body>
<s:form action="qyfydjxm!query" namespace="/zygl" method="post" id="mainForm" name="mainForm">
	...
	<fieldset>
		<legend>查询条件</legend>
		   <table width="99%" border="0" cellspacing="0" cellpadding="0">
		   		<tr>
		          <td width="12%" align="right">费用登记项目：</td>
		          <td width="21%"><s:textfield name="domain.fydjXmmc" cssClass="pop_input_colspan2  bgstyle_optional" ></s:textfield></td>
		          <td width="8%" align="right">车辆属性：</td>
		          <td width="20%"><s:select id="clsxDm" list="#{1:'自由车辆',2:'社会车辆'}" headerKey="" headerValue="全部车辆" cssClass="select"></s:select></td>
