...
<script type="text/javascript">
		...
		var url = jcontextPath+"/cwgl/cwzjdbgl!query";   
		 $("#dataList").jqGrid("setGridParam",{
		 	...
		 	postData:{"domain.drDwDjxh":encodeURI(drDwDjxh),
				      "domain.rqQ":rqQ,"domain.rqZ":rqZ}								//请求的参数，json格式
		 }
	...
	function initDataGrid(){ 
		  $("#dataList").jqGrid({
		    ...
		    shrinkToFit:false, 
		    colNames:['操作','调拨金额', '实际调拨金额','实际调拨日期','接收金额','接收日期','转出单位','转入单位','计划日期',
				     '备注说明','创建人',
...
<s:form action="cwzjdbgl!query" namespace="" method="post" id="mainForm" name="mainForm">
	...
	<fieldset>
	   ...
	   <table width="95%" border="0" cellspacing="0" cellpadding="0">
	        <tr>
	          <td width="12%" align="right">转入单位：</td>
	          ...
	          <td align="right" width="15%">计划日期起止：</td>
        			<td width="25%">
