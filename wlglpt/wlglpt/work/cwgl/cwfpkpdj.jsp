...
<script type="text/javascript">
	...
	function onRefresh(){
		...
		var url = jcontextPath+"/cwgl/cwfpkpdj!query.action";   
		 $("#dataList").jqGrid("setGridParam",{
		 	url:url,
		 	datatype:'json',
		 	postData:{"domain.kpdwJgbm":encodeURI(kpdwJgbm), "domain.khDjxh":khDjxh,"domain.khmc":encodeURI(khmc)}								//请求的参数，json格式
		 }
	...
	function initDataGrid(){
		  $("#dataList").jqGrid({
		    ...
		    shrinkToFit:false, 
		    colNames:['操作','开票申请登记序号','开票申请方式代码','客户登记序号','申请开票金额合计','申请开票日期','发票开具金额',
				     '申请人', '申请部门', '申请时间', '开票单位', '备注说明'],			 //name 列显示的名称
		    ...
		    sortname: 'kpsqDjxh',				//默认排序 可以是列名称或者是一个数字，这个参数会被提交到后台
    ...
    //表格加载完毕后触发事件：修改操作列的内容，显示“修改”、“登记”，并增加链接
