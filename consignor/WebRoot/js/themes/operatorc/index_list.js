	   	...
	   	success:function(data){//回传函数
			...
			for(var i =0;i<data.length;i++){ //展现返回的表格数据
				...
				txt='<td class="tdcenter1" class="tdcenter">'+data[i].operator+'</td>'+
					...
					'<td class="tdcenter1" class="tdcenter"><a href="#" style="color:#1560ea;padding-left:50px;" onClick="f_detail(&quot;'+data[i].operatorid+'&quot;,&quot;'+data[i].operatorid+'&quot;);">'+ "详情"+'</a><a href="#" style="color:#1560ea; padding-left:10px;" onClick="f_edit(&quot;'+data[i].operatorid+'&quot;);">'+ "修改"+'</a><a href="#" style="color:#1560ea;padding-left:10px;" onClick="f_delete(&quot;'+data[i].operatorid+'&quot;,&quot;'+data[i].operator+'&quot;);">'+ "删除"+'</a><a href="#" style="color:#1560ea;padding-left:10px;" onClick="f_repwd(&quot;'+data[i].operatorid+'&quot;,&quot;'+data[i].operator+'&quot;);">'+ "重置密码"+'</a></td>';		 
...
function f_detail(operid,oper){
	window.location="../operatorcs/index_listdetail_contract?order=4&&id="+(operid+"/"+oper);
}
//跳转到修改页面并传id值
function f_edit(operid){
	window.location="../operatorcs/index_operatoredit_contract?order=4&id="+operid;
}
function f_add(){
	window.location="../operatorcs/index_add_contract?order=4";
}
