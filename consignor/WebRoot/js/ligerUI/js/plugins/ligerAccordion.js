...
{  
    ...
    $.ligerui.controls.Accordion.ligerExtend($.ligerui.core.UIComponent, {
        ...
        {	
            ...
            g.accordion = $(g.element);//l-accordion-panel
            ...
            $("> div", g.accordion).each(function (i, box)
            {
                ...
                if (i == selectedIndex)
                    $(".l-accordion-toggle", header).addClass("l-accordion-toggle-open");//the <div class="l-accordion-toggle"></div> is open
                if ($(box).attr("title"))
                {
            ...
            $(".l-accordion-toggle", g.accordion).each(function ()
            {
                ...
                {
                    $(this).parent().next(".l-accordion-content:visible").hide();//hidden the <div class="l-accordion-toggle"></div>  all brother node
                }
            });
            ...
            var click=$(">.l-accordion-header", g.accordion).click(function ()
            {
