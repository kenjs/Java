 ...
 *
 */
public class SelectCargoSuitOrderListAction extends BaseJsonAction{

	/**
	 * 
	 */
	private static final long serialVersionUID = 5908687099803416750L;
	...
	private void log2Db(String driverId) {
		...
		bo.setOperationName("selectCargoSuitOrderListAction");
		bo.setOperationType(15);
		bo.setRemark("符合预约的货列表");
