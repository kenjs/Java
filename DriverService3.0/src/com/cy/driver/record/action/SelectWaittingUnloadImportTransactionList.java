 ...
 *
 */
public class SelectWaittingUnloadImportTransactionList extends BaseJsonAction{
	...
	private void log2Db(String driverId) {
		...
		bo.setOperationName("selectWaittingUnloadImportTransactionList");
		bo.setOperationType(72);
		bo.setRemark("查找导入的待卸货订单");
