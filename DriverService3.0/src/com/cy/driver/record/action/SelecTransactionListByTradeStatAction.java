 ...
 *
 */
public class SelecTransactionListByTradeStatAction extends BaseJsonAction{
	...
	public String exec() {
		try {
			...
			String tradeStat = request.getParameter("tradeStart");			
			//分页相关
	...
	private void log2Db(String driverId) {
		...
		bo.setOperationName("selecTransactionListByTradeStatAction");
		bo.setOperationType(38);
		bo.setRemark("根据交易状态查找");
