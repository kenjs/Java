 ...
 *
 */
public class SelectWaittingLoadImportTransactionList extends BaseJsonAction{
	...
	private void log2Db(String driverId) {
		...
		bo.setOperationName("selectWaittingLoadImportTransactionList");
		bo.setOperationType(73);
		bo.setRemark("查找导入的待装货订单");
