...
public class ExportOrderCargoLastInfoAction extends BasePageAction {
	...
	protected String execMethod() throws Exception {
		...
		orderCargoLastInfoService.exportOrderCargoLastInfo(orderCargoLastInfoDomain);
		ByteArrayOutputStream out = new ByteArrayOutputStream();
		putDataOnOutputStream(out,orderCargoLastInfoDomain.getDataList());
		excelStream = new ByteArrayInputStream(out.toByteArray());
		return "excel";
	}
	
	public void putDataOnOutputStream(OutputStream os,List<OrderCargoLastInfoDomain> dataList) throws IOException {
...
//            ws.setColumnView(7, 12);
        ...
        String[] excelNameArray = {"序号","货源ID","司机ID","司机账号","司机姓名","状态类型","备注"};
	        ...
	        for (int i = 0; i < dataList.size(); i++){
		        for (int j=0;j < len;j++){
		        	OrderCargoLastInfoDomain eclDomain = new OrderCargoLastInfoDomain();
		        	...
		        	newLabel[num] = eclDomain.getStateType();num++;
