...
public class SaveTransactionInfoAction extends BasePageAction {
	...
	protected String execMethod() throws Exception {
		logger.debug("save transactionInfo start");
		if(getSessionUser()==null){
			sendResponseMessage("loginMx");
			return SUCCESS;
		}
		transactionInfoService.saveTransactionInfo(transactionInfoDomain,getSessionUser().getId());
		return SUCCESS;
	}
