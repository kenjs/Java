...
public class DeleteUserDriverAssessInfoAction extends BasePageAction {
	...
	protected String execMethod() throws Exception {
		logger.debug("delete userDriverAssessInfo start");
		if(getSessionUser()==null){
			sendResponseMessage("login");
			return SUCCESS;
		}
		userDriverAssessInfoService.deleteUserDriverAssessInfo(userDriverAssessInfoDomain.getId(),getSessionUser().getId());
		return SUCCESS;
	}
