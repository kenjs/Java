...
function pageTableHeight(){
		...
		//alert("pageTableHeight"+pageTableHeight+"tip.scrollHeight:"+tip.scrollHeight);
...
function popwindow(url,width,height,myContentStr,yesCallBack,noCallBack){
	 ...
	 if(myContentStr.indexOf("12100") > -1){ //如果未登录，跳转到登录页面
		 //alert(myContentStr);
		 parent.parent.location.href = jcontextPath+"/login.jsp";
	 }
