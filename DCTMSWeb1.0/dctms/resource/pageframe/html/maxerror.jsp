...
<div class="pop_cont">
  <div class="pop_contc" style="height:200px; overflow:auto;">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="30%" height="60" align="center"><img src="<sys:context/>/resource/pageframe/images/err.gif" /></td>
        <td width="70%"><div style="height:120px; overflow-y:auto;"><%=com.cy.dcts.common.util.ConvertCharactersUtil.convertISO2GBK(request.getParameter("myContentStr"))%></div></td>
      </tr>
    </table>
    <div class="pop_btn">
