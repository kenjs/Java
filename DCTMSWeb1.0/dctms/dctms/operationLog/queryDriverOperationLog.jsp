...
<script type="text/javascript">
	window.onload=function(){
		queryConditionInit();
		document.getElementById("mainForm_operationLogDomain_type").value = '1';
		queryInfoInit();
	} ;
	function queryInfo(){
		var data ={
	...
	function callBackList(text){
        ...
        var columus =["userDriverCode","userDriverName","createTime","remark"];
		var operateObject = {};
		var operateObjectMultiParameter = {'jumpHtml(8,1,':['userDriverId','司机']};
