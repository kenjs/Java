...
function addFavorite()
 {
	var sURL = "http://www.bus.tf56.com";
	var sTitle = "传化物流官方网站";
	try
	 {
...
function sendCitiesAjax() {
	$.ajax({
		type: "get",
		url: '../js/citypub/queryAllCities.js',
		async: false,
		dataType: "json",
...
function sendAllProvinceAjax() {
	$.ajax({
		type: "get",
		url: '../js/citypub/queryAllProvinces.js',
		async: false,
		dataType: "json",
		success: function(data) {
...
function sendAllCountiesAjax()
 {
	$.ajax({
		type: "get",
		url: "../js/citypub/queryAllAreas.js",
		async: false,
		dataType: "json",
		success: function(data) {
			allAreas = data.areas;
