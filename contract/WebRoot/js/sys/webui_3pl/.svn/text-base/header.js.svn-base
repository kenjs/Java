...
document.write('<link rel="stylesheet" type=text/css href="../css/webui_3pl/header.css"/>');
document.write('<script type=text/javascript src="../js/sys/webui_3pl/top.js"></script>');
/*头部结束*/