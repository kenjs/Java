...
$(function() {
			html = '<div id=page><div class="chl-poster simple" id=header>'
								...
								+ '</li><li id="lisecond"><a href="../logincs/logout?random='+Math.random()+'">退出</a></li><li><a href="http://abc.tf56.com/Login.asp" target="_blank">切回旧版</a> </li>'
	...
	$.ajax( {
				...
				success : function(data) {
					if (data.username_part == "" || data.username_part == null) {
						...
						$('#lisecond').after('<li><a href="../front/index.html">返回首页</a> </li>');
					}
				},
