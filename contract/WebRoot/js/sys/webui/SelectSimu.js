	...
	_SelectSimu.prototype = {
		init : function(){
			...
			var cssStr = 	'<style>'+
							...
							className + '.selectInput span{width:80%; height: 17px; line-height:19px; padding:2px; display: block; overflow: hidden; border:none;}'+
							className + '.selectInput i{display:block; position: absolute; right:1px; top:6px; background: url("'+_this.opts.imgSrc+'") center center no-repeat; width:14px; height: 14px;}'+
