	function onFocus(e){
			var id=$(e).attr("id");
			$(e).css("border","1px solid  #a0cfe0");
			var id1="#"+id;
			var warn=id1+"_message";
			$(warn).remove();
			var wordInput=$(id1);
	        var wordInputOffset = wordInput.offset();  
	        var partyType=wordInput.attr("name");
	        if(partyType=="subcontractor"){
	        	partyType="linked";
	        }else{
	        	partyType="发货方";
	        }
	                ...
	                {  
	                    ...
	                    {  
	                        ...
	                        $.ajax(  
	                            {  
	                                type: "POST",  
	                                url: "../citydistancecs/autoCompleteServlet",  
	                                data: {"word":wordText,"frompartyid":$("#frompartyid").val(),"partytype":partyType},  
	                                dataType:"json",  
