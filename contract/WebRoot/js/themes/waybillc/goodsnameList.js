	function onFocues_goods(e,values){
		//alert("ss");
			...
			$("#goodsname"+values+"_message").remove();
	    	var wordInput=$(id1);
	                    ...
	                    {  
	                        ...
	                        $.ajax(  
	                            {  
	                                ...
	                                data:"topartyid="+toPartyId+"&goodsname="+wordText,  
	                                dataType:"json",  
...
//	                                    alert(data);  
	                                    ...
	                                    {  
	                                        ...
	                                        $.each(data,function(i,item){  
	                                            var newDivNode=$("<div>").attr({"id":i,"myid":data[i].goodsTypeId});
	                                            var city = data[i].goodsName;  
	    //                                      alert(city.cname);  
	                                            ...
	                                            function (){  
	                        	                    ...
	                        	                    consignorgoods(concomTextTag,values);
	                                            }  
	                                            );  
