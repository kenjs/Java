	function onFocues(e){
			$(consignorlinkmanFlag).remove();
			consignorlinkmanFlag="";
			if(f_check_frompartyid() == false) {
				return;
			}
	                    ...
	                    {  
	                        ...
	                        $.ajax(  
	                            {  
	                                ...
	                                data:"topartyid="+toPartyId+"&consigneeorconsignor=0&linkman="+wordText,  
	                                dataType:"json",  
	    ...
	    //                                      alert(city.cname);  
	                                            ...
	                                            function (){  
	                        	                    ...
	                        	                    consignorlinkname(concomTextTag);//取发货方联系人详细信息
